...
def update(version,currentVersion):
    if version != currentVersion:
        print("Trying to download the latest version!")
        with open(f"toDoListNew.exe","wb")as f:
            f.write(requests.get("https://github.com/NiloyBormon/toDoList/raw/refs/heads/main/toDoList.exe").content)
        print("Latest version download compleet! Restart the app!")
        with open("version.json","w") as f:
...
print("Downloading the required files!")
with open("update.exe","wb") as f:
            f.write(requests.get("https://github.com/NiloyBormon/toDoList/raw/refs/heads/main/update.exe").content)
print("Required files download done!")

update(version,getCurrentVersion())
